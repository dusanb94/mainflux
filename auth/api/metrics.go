...
func (ms *metricsMiddleware) Issue(ctx context.Context, issuer string, key auth.Key) (auth.Key, error) {
...
func (ms *metricsMiddleware) Retrieve(ctx context.Context, issuer, id string) (auth.Key, error) {
	defer func(begin time.Time) {
